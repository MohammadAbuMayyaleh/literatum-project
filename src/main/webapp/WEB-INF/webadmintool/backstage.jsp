        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="#pablo">Backstage</a>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card card-plain">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title mt-0"> Submissions</h4>
                                <p class="card-category">Upload and submit articles</p>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        <form action="/backstage/upload/" enctype="multipart/form-data" method="post">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary pull-right  col-6" type="submit">
                                                        Upload
                                                    </button>
                                                </td>
                                            </tr>
