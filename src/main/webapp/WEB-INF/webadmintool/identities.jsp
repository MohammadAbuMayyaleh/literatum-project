      ...
      -->
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="identities">
                        <i class="material-icons">person</i>
                        <p>Identities</p>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="backstage">
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand">Identities</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <p class="card-category">Add user to the system</p>
                            </div>
                            <div class="card-body">
                                <form action="/identities/create/user" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password"  class="form-control" name="passwordRepeated" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <select name="role" class="form-control bmd-label-floating" required>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Add Licenses</h4>
                                <p class="card-category">Add Licenses to the users</p>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <p class="card-category">All the user of the system</p>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <c:forEach items="${users}" var="user">
                                            <c:if test="${user.id!=currentUser.getId()}">
                                            <tr>
                                                <td>${user.id}</td>
                                                ...
                                                <td>${user.role}</td>
                                                <td>
                                                    <form action="/identities/remove/${user.id}" method="post">
